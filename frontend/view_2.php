...
<body>
    ...
    <div class="container pt-3">
        <div class="d-flex">
            <h4 class="h4 fw-bold title mt-3">
                <a href="/frontend/create_order.php?user_id=<?php echo $user_id;?>" class="btn btn-primary">Создать новый заказ</a>
            </h4>
        </div>
        <div class="d-flex mt-3">
            <h4 class="h4 fw-bold title">Список принятых заказов за активную смену</h4>
        </div>
                ...
                <?php foreach ($orders as $row) {
                    ...
                    echo "<td class='d-flex gap-1 flex-column'>
                        <form method='POST'>
                            ...
                            <button class='btn btn-sm btn-outline-success' name='orderstatus' value='принят'>Принят</button>
                            <button class='btn btn-sm btn-outline-primary' name='orderstatus' value='не принят'>Не принят</button>
                        </form>
                    </td>";
                    echo "</tr>";
                } ?>
